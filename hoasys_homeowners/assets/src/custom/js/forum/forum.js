				...
				$.each(data.forum_replies, function (index, reply) {
					...
					var replyHtml = `
                        <div class="comment mt-3 comment_design">
                            ...
                            <button type="button" data-id="${reply.id_forum_rep}" data-forumid="${reply.id_forum}" ${display_css} class="btn btn-link text-danger delete_forum_comment">Delete</button>
				...
				$.each(data.forum_sub_comments, function (index, subComment) {
					...
					var subCommentHtml = `
                        <div class="comment mt-3 sub_comments_design">
							...
							<button type="button" ${display_css} data-id="${subComment.id_forum_rep}" data-forumid="${subComment.id_forum}" data-replyid="${subComment.reference}" class="btn btn-link text-danger delete_sub_comment">Delete</button>
                        </div>
                    `;
