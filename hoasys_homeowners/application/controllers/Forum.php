...
class Forum extends General
{
    ...
    public function index()
    {
        if ($this->session->userdata("id_ho")) {
			...
			$data["session_id"] = $this->session->userdata("id_ho");
	...
	public function save_forum() {
		...
		$forum['published_by'] = $this->session->userdata("fullname")." "."(Homeowner)";
		$forum['id_ho'] = $this->session->userdata("id_ho");
		$forum['id_admin'] = 0;
		$forum['visibility'] = "all";
	...
	public function save_forum_comment() {
		...
		$forum['commented_by'] = $this->session->userdata("fullname")." "."(Homeowner)";
		$forum['id_ho'] =  $this->session->userdata("id_ho");
		$forum['reference'] =  0;
		$forum['id_admin'] =  0;
